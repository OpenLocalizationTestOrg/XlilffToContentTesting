---
ms.openlocfilehash: 49d010328dcc34a52d8d3c6b437a5e16990e59a5
...
## <a name="open-the-query-editor-in-the-azure-portal"></a>Open the query editor in the Azure portal
...
## <a name="create-an-import-database"></a>Create an import database
...
## <a name="create-an-external-data-source-connection"></a>Create an external data source connection
...
## <a name="define-the-import-file-format"></a>Define the import file format
...
## <a name="create-a-destination-table"></a>Create a destination table
...
## <a name="add-statistics-onto-columns-to-improve-query-performance"></a>Add statistics onto columns to improve query performance
