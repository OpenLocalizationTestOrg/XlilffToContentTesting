...
## <a name="create-an-azure-data-warehouse-login-by-using-sql-server-management-studio"></a>Create an Azure Data Warehouse login by using SQL Server Management Studio
