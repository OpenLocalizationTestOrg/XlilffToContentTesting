---
ms.openlocfilehash: dbc478fa5bbe3d36bcf7e479a205a11410406130
...
## <a name="create-the-function"></a>Create the function
...
## <a name="create-a-class-to-share-data-between-the-mobile-app-and-function"></a>Create a class to share data between the mobile app and function
...
## <a name="read-the-data-sent-to-the-function"></a>Read the data sent to the function
...
## <a name="run-the-azure-functions-locally"></a>Run the Azure Functions locally
