---
ms.openlocfilehash: 3b5c55284e8204c51e09bde938cbf83a5cfe1289
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/24/2019
---
Capturing of weather data is an important task as weather can effect everything from traffic patterns to how heating, ventilation, and air conditioning (HVAC) systems in retail stores are operated. In this exercise, you will be interacting with the online Raspberry Pi simulator you learned about in the previous unit to capture simulated weather data and via the Azure IoT Hub.
...
## <a name="send-simulated-telemetry"></a>Send simulated telemetry
...
## <a name="read-the-telemetry-from-your-hub"></a>Read the telemetry from your hub
