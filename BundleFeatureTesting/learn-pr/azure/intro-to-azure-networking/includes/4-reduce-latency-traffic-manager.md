---
ms.openlocfilehash: 230a49bcdad363b053d9cf2bc564e5da1f2e181c
...
## <a name="what-is-network-latency"></a>What is network latency?
...
## <a name="scale-out-to-different-regions"></a>Scale out to different regions
...
## <a name="use-traffic-manager-to-route-users-to-the-closest-endpoint"></a>Use Traffic Manager to route users to the closest endpoint
...
## <a name="compare-load-balancer-to-traffic-manager"></a>Compare Load Balancer to Traffic Manager
