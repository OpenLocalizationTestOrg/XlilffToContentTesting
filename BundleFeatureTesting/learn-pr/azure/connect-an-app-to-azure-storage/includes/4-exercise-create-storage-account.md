---
ms.openlocfilehash: 916e3f93785335e8b1dec86879be0e2227295c17
...
## <a name="use-the-azure-cli-to-create-an-azure-storage-account"></a>Use the Azure CLI to create an Azure storage account
...
### <a name="selecting-a-location"></a>Selecting a location
<!-- Resource selection -->
...
### <a name="example-command"></a>Example command
