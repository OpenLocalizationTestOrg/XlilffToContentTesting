---
ms.openlocfilehash: bc667ba63ffe88b8fc5eb1337291f53bb63f3c9e
...
## <a name="create-a-json-configuration-file"></a>Create a JSON configuration file
...
## <a name="create-a-env-configuration-file"></a>Create a .env configuration file
...
## <a name="add-support-to-read-an-environment-configuration-file"></a>Add support to read an environment configuration file
