---
ms.openlocfilehash: 0cc32d19ea3e9a742b2c8c248d6c78952d445b56
...
## <a name="connect-to-the-vm-with-remote-desktop-protocol"></a>Connect to the VM with Remote Desktop Protocol
...
### <a name="download-the-rdp-file"></a>Download the RDP file
...
### <a name="connect-to-the-windows-vm"></a>Connect to the Windows VM
...
### <a name="install-worker-roles"></a>Install worker roles
...
## <a name="install-custom-software"></a>Install custom software
...
## <a name="initialize-data-disks"></a>Initialize data disks
