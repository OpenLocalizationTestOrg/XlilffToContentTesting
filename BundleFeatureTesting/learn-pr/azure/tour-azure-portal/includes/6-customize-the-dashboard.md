---
ms.openlocfilehash: 44816b990575473e039b8552e1f3394e49c30f12
...
## <a name="what-is-a-dashboard"></a>What is a dashboard?
...
## <a name="explore-the-default-dashboard"></a>Explore the default dashboard
...
## <a name="creating-and-managing-dashboards"></a>Creating and managing dashboards
...
## <a name="select-dashboard"></a>Select dashboard
...
## <a name="create-a-new-dashboard"></a>Create a new dashboard
...
## <a name="upload-and-download"></a>Upload and Download
...
## <a name="edit-a-dashboard-using-the-portal"></a>Edit a dashboard using the portal
...
#### <a name="change-tile-sizes"></a>Change tile sizes
...
#### <a name="change-tile-settings"></a>Change tile settings
...
#### <a name="accepting-your-edits"></a>Accepting your edits
...
## <a name="edit-a-dashboard-by-changing-the-json-file"></a>Edit a dashboard by changing the JSON file
...
## <a name="reset-a-dashboard"></a>Reset a dashboard
...
## <a name="share-or-unshare-a-dashboard"></a>Share or unshare a dashboard
...
### <a name="switching-to-a-shared-dashboard"></a>Switching to a shared dashboard
...
## <a name="display-a-dashboard-as-a-full-screen"></a>Display a dashboard as a full screen
...
## <a name="clone-a-dashboard"></a>Clone a dashboard
...
## <a name="delete-a-dashboard"></a>Delete a dashboard
