---
ms.openlocfilehash: 06a1359b642b0148253aad80c010bcd3ec988aae
...
## <a name="set-up-the-database"></a>Set up the database
...
## <a name="clone-the-chat-app-repository"></a>Clone the Chat App repository
...
## <a name="add-code-to-detect-errors"></a>Add code to detect errors
...
## <a name="create-an-error"></a>Create an error
