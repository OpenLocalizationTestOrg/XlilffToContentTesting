---
ms.openlocfilehash: 8286f12914e56500c1874f34bfc2fb432c264e1d
...
::: zone pivot="csharp"
## <a name="use-a-class-to-implement-a-retry-policy"></a>Use a class to implement a retry policy
...
## <a name="add-a-retry-policy"></a>Add a retry policy
...
::: zone-end
::: zone pivot="node"
## <a name="use-a-function-to-implement-a-retry-policy"></a>Use a function to implement a retry policy
...
## <a name="test-the-retry-code"></a>Test the retry code
...
## <a name="change-the-retry-policy"></a>Change the retry policy
