---
ms.openlocfilehash: d0e038f37eaf5c7e2bf96a883f42921bd2de39fd
...
::: zone pivot="csharp"
### <a name="add-logging-provider"></a>Add logging provider
...
### <a name="add-logging"></a>Add logging
...
::: zone-end
::: zone pivot="node"
### <a name="add-a-logging-provider"></a>Add a logging provider
...
### <a name="test-the-new-logging"></a>Test the new logging
