---
ms.openlocfilehash: dc15131bffc2144a67cca670cba3e902c5575724
...
## <a name="create-an-access-key"></a>Create an access key
...
1. In the **Create** page that opens, enter the following values into each field.
    ...
    ### <a name="sandbox-region-list"></a>Sandbox region list
...
## <a name="get-the-access-key"></a>Get the access key
...
## <a name="call-the-api-from-the-testing-console"></a>Call the API from the testing console
...
## <a name="make-some-api-calls"></a>Make some API calls
