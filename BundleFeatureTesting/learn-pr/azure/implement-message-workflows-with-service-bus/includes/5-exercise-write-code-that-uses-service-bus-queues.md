---
ms.openlocfilehash: 11d284aedfb96928d80416c27bf1e1d9691d71fb
...
## <a name="clone-and-open-the-starter-application"></a>Clone and open the starter application
...
## <a name="configure-a-connection-string-to-a-service-bus-namespace"></a>Configure a connection string to a Service Bus namespace
...
## <a name="write-code-that-sends-a-message-to-the-queue"></a>Write code that sends a message to the queue
...
## <a name="send-a-message-to-the-queue"></a>Send a message to the queue
...
## <a name="write-code-that-receives-a-message-from-the-queue"></a>Write code that receives a message from the queue
...
## <a name="retrieve-a-message-from-the-queue"></a>Retrieve a message from the queue
