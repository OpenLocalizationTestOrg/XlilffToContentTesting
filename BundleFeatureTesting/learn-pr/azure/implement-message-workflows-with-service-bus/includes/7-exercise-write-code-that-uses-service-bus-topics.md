---
ms.openlocfilehash: 23ec53f78438e3bf2524e4137ed748f599a1c321
...
## <a name="write-code-that-sends-a-message-to-the-topic"></a>Write code that sends a message to the topic
...
## <a name="send-a-message-to-the-topic"></a>Send a message to the topic
...
## <a name="write-code-that-receives-a-message-from-a-topic-subscription"></a>Write code that receives a message from a topic subscription
...
## <a name="retrieve-a-message-from-a-topic-subscription"></a>Retrieve a message from a topic subscription
