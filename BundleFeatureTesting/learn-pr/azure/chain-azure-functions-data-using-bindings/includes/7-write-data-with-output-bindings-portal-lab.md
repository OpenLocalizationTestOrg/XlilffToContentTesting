---
ms.openlocfilehash: 5da55c936c62d6f75c95e923bebedbc6c9e42401
...
## <a name="create-an-http-triggered-function"></a>Create an HTTP-triggered function
...
## <a name="add-an-azure-cosmos-db-input-binding"></a>Add an Azure Cosmos DB input binding
...
## <a name="add-an-azure-cosmos-db-output-binding"></a>Add an Azure Cosmos DB output binding
...
## <a name="add-an-azure-queue-storage-output-binding"></a>Add an Azure Queue Storage output binding
...
## <a name="update-function-implementation"></a>Update function implementation
...
### <a name="verify-that-a-message-is-written-to-the-queue"></a>Verify that a message is written to the queue
