---
ms.openlocfilehash: 15e7778d706e9fe5696ecde51b601eedcba895c4
...
## <a name="add-the-client-library-for-azure-storage"></a>Add the client library for Azure Storage
...
## <a name="add-a-method-to-send-a-news-alert"></a>Add a method to send a news alert
...
## <a name="add-code-to-send-a-message"></a>Add code to send a message
...
## <a name="check-your-results"></a>Check your results
...
## <a name="optional---use-the-async-versions-of-the-methods"></a>Optional - Use the async versions of the methods
