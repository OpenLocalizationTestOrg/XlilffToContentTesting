---
ms.openlocfilehash: e624e7fb88691cf8d2990edb0e563806ed10fda1
...
## <a name="capex-computing-costs"></a>CapEx computing costs

A typical on-premises data center includes costs such as:

### <a name="server-costs"></a>Server costs
...
### <a name="network-costs"></a>Network costs
...
### <a name="backup-and-archive-costs"></a>Backup and archive costs
...
### <a name="organization-continuity-and-disaster-recovery-costs"></a>Organization continuity and disaster recovery costs
...
### <a name="datacenter-infrastructure-costs"></a>Datacenter infrastructure costs

These are costs for electricity, floor space, cooling, and building maintenance.

### <a name="technical-personnel"></a>Technical personnel
...
## <a name="opex-cloud-computing-costs"></a>OpEx cloud computing costs
...
### <a name="leasing-a-cloud-based-server"></a>Leasing a cloud-based server

If you lease a server or use a cloud-based server, the cost is typically based on the pay-per-use model. 

### <a name="leasing-software-and-customized-features"></a>Leasing software and customized features
...
### <a name="scaling-charges-based-on-usagedemand-instead-of-fixed-hardware-or-capacity"></a>Scaling charges based on usage/demand instead of fixed hardware or capacity. 
...
### <a name="billing-at-the-user-or-organization-level"></a>Billing at the user or organization level.
...
## <a name="benefits-of-capex"></a>Benefits of CapEx
...
## <a name="benefits-of-opex"></a>Benefits of OpEx
