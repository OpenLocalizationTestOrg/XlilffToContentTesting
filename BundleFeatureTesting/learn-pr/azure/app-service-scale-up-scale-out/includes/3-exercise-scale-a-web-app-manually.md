---
ms.openlocfilehash: 74f164f9351b8e3c056fb2ddb470c28f4b35b234
...
## <a name="create-an-app-service-plan-and-web-app"></a>Create an App Service plan and web app
...
## <a name="build-and-deploy-the-web-app"></a>Build and deploy the web app
...
## <a name="monitor-the-performance-of-the-web-app-before-scaling-out"></a>Monitor the performance of the web app before scaling out
...
## <a name="scale-out-the-web-app-and-verify-the-performance-improvement"></a>Scale out the web app and verify the performance improvement
