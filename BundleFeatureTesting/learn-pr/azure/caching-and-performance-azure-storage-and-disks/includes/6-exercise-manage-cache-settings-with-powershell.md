---
ms.openlocfilehash: 4a069bd216a0e031c903dd76b5d62130d0474c5f
...
### <a name="set-up-some-variables"></a>Set up some variables
...
### <a name="get-info-about-our-vm"></a>Get info about our VM
...
### <a name="view-os-disk-cache-status"></a>View OS disk cache status
...
### <a name="change-the-cache-settings-of-the-os-disk"></a>Change the cache settings of the OS disk
...
### <a name="list-data-disk-info"></a>List data disk info
...
### <a name="add-a-new-data-disk-to-our-vm"></a>Add a new data disk to our VM
...
### <a name="change-cache-settings-of-new-data-disk"></a>Change cache settings of new data disk
