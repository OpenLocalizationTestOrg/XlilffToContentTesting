---
ms.openlocfilehash: 397282389a61dbf26a7255c06d92d2ee2217f5e2
...
## <a name="view-os-disk-cache-status-in-the-portal"></a>View OS disk cache status in the portal
...
## <a name="change-the-cache-settings-of-the-os-disk-in-the-portal"></a>Change the cache settings of the OS disk in the portal
...
## <a name="add-a-data-disk-to-the-vm-and-set-caching-type"></a>Add a data disk to the VM and set caching type
