---
ms.openlocfilehash: cfe421d18136246112682deb1f9eef70574f6464
...
## <a name="add-the-connection-string"></a>Add the connection string
...
## <a name="add-support-to-read-a-json-configuration-file"></a>Add support to read a JSON configuration file
...
## <a name="add-code-to-read-the-configuration-file"></a>Add code to read the configuration file
...
## <a name="get-the-connection-string-from-configuration"></a>Get the connection string from configuration
...
## <a name="add-support-for-the-redis-cache-net-client"></a>Add support for the Redis cache .NET client
...
## <a name="connect-to-the-cache"></a>Connect to the cache
...
## <a name="add-a-value-to-the-cache"></a>Add a value to the cache
...
## <a name="get-a-value-from-the-cache"></a>Get a value from the cache
...
## <a name="use-the-async-versions-of-the-methods"></a>Use the async versions of the methods
...
### <a name="switch-to-c-71"></a>Switch to C# 7.1
...
### <a name="apply-the-async-keyword"></a>Apply the async keyword
...
### <a name="get-and-set-values-asynchronously"></a>Get and set values asynchronously
...
#### <a name="increment-the-value"></a>Increment the value
