---
ms.openlocfilehash: 5dd7fc94b182be5726360663838b14d220098196
...
## <a name="using-load-tests-in-azure-devops"></a>Using load tests in Azure DevOps
...
### <a name="viewing-tests"></a>Viewing tests
...
### <a name="comparing-test-results"></a>Comparing test results
...
### <a name="configuring-tests-in-azure-devops"></a>Configuring tests in Azure DevOps
...
### <a name="using-recorded-user-actions-in-tests"></a>Using recorded user actions in tests
