---
ms.openlocfilehash: 558a63da2a33815238e2f94e2ad1b81a28d7c624
...
## <a name="plan-your-performance-tests"></a>Plan your performance tests
...
### <a name="create-tests-in-the-azure-portal"></a>Create tests in the Azure portal 
...
### <a name="create-tests-in-azure-devops"></a>Create tests in Azure DevOps 
...
## <a name="performance-testing-in-the-azure-portal"></a>Performance testing in the Azure portal

The high-level steps to configure and run a performance test by using the Azure portal are outlined here.

### <a name="1-open-your-web-app"></a>1. Open your web app
...
### <a name="2-link-to-your-azure-devops-account"></a>2. Link to your Azure DevOps account
...
### <a name="3-configure-the-test"></a>3. Configure the test
...
### <a name="4-run-the-test"></a>4. Run the test
...
### <a name="5-running-the-test-again"></a>5. Running the test again
