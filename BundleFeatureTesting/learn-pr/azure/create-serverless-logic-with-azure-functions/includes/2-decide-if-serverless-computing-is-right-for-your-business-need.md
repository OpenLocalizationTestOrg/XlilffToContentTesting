---
ms.openlocfilehash: 195a50daa722c5267461d6eb24738d540cec736f
...
## <a name="what-is-serverless-compute"></a>What is serverless compute?
...
## <a name="what-is-azure-functions"></a>What is Azure Functions?
...
## <a name="benefits-of-a-serverless-compute-solution"></a>Benefits of a serverless compute solution
...
### <a name="avoids-over-allocation-of-infrastructure"></a>Avoids over-allocation of infrastructure
...
### <a name="stateless-logic"></a>Stateless logic
...
### <a name="event-driven"></a>Event driven
...
### <a name="functions-can-be-used-in-traditional-compute-environments"></a>Functions can be used in traditional compute environments
...
## <a name="drawbacks-of-a-serverless-compute-solution"></a>Drawbacks of a serverless compute solution
...
### <a name="execution-frequency"></a>Execution frequency
