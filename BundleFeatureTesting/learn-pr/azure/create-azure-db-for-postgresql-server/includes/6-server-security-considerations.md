---
ms.openlocfilehash: 531e5ae9cb56bd077e7b7edbdd579ad34625f636
...
## <a name="server-security-considerations-and-connection-methods"></a>Server security considerations and connection methods
...
### <a name="what-is-a-virtual-network"></a>What is a virtual network?
...
### <a name="what-is-a-firewall"></a>What is a firewall?
...
### <a name="azure-database-for-postgresql-server-firewall"></a>Azure Database for PostgreSQL server firewall
...
### <a name="azure-database-for-postgresql-server-ssl-connections"></a>Azure Database for PostgreSQL server SSL connections
...
## <a name="configure-connection-security"></a>Configure connection security
...
### <a name="allow-access-to-azure-services"></a>Allow access to Azure services
...
### <a name="create-a-firewall-rule-using-the-portal"></a>Create a firewall rule using the portal
...
### <a name="create-a-firewall-rule-using-the-azure-cli"></a>Create a firewall rule using the Azure CLI
...
## <a name="connecting-to-your-server"></a>Connecting to your server
...
### <a name="what-is-psql"></a>What is psql?
