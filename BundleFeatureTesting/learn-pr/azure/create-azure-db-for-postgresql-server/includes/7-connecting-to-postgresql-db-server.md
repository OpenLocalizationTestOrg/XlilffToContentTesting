---
ms.openlocfilehash: 5fe0ce2901ba88dc8772f066d55309530f94846a
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/24/2019
---
## <a name="allow-azure-service-access"></a>Allow Azure service access
...
### <a name="create-a-firewall-rule"></a>Create a firewall rule
...
### <a name="connect-to-the-database-with-psql"></a>Connect to the database with psql
