---
ms.openlocfilehash: 0c39e12523e80bd51209b7dea2befbe6776423c9
...
## <a name="create-an-azure-database-for-postgresql-server-using-the-azure-cli"></a>Create an Azure Database for PostgreSQL server using the Azure CLI
