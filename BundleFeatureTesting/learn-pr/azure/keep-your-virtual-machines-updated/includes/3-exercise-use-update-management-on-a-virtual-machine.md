---
ms.openlocfilehash: 4b8619992115f303cbce2c9923decbf3bf45cfb5
...
## <a name="onboard-update-manager-to-the-vm"></a>Onboard Update Manager to the VM
...
## <a name="examine-hybrid-worker-groups"></a>Examine Hybrid Worker Groups
