---
ms.openlocfilehash: 06c64b7bf6166379b42efe6309de4e07c544d4af
...
## <a name="how-to-create-a-disaster-recovery-plan"></a>How to create a disaster recovery plan
...
### <a name="risk-assessment-and-process-inventory"></a>Risk assessment and process inventory
...
### <a name="recovery-objectives"></a>Recovery objectives
...
### <a name="detailing-recovery-steps"></a>Detailing recovery steps
...
## <a name="designing-for-disaster-recovery"></a>Designing for disaster recovery
...
### <a name="data-recovery-and-replication"></a>Data recovery and replication
...
### <a name="process-recovery"></a>Process recovery
...
#### <a name="service-specific-features"></a>Service-specific features
...
## <a name="testing-a-disaster-recovery-plan"></a>Testing a disaster recovery plan
