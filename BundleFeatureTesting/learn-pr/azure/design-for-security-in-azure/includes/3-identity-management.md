---
ms.openlocfilehash: eee8a99cbe9afedf57cdad9a37ab196c0129257f
...
## <a name="identity-as-a-layer-of-security"></a>Identity as a layer of security
...
### <a name="sso-with-azure-active-directory"></a>SSO with Azure Active Directory
...
### <a name="synchronize-directories-with-ad-connect"></a>Synchronize directories with AD Connect
...
## <a name="authentication--access"></a>Authentication & access
...
## <a name="securing-legacy-applications"></a>Securing legacy applications
...
## <a name="working-with-consumer-identities"></a>Working with consumer identities
...
## <a name="identity-management-at-lamna-healthcare"></a>Identity management at Lamna Healthcare
