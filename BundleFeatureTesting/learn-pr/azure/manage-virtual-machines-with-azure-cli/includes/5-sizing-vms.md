---
ms.openlocfilehash: 2dd7e1a38327dd9d9b0bfdb6e103051d0b4fa06b
...
## <a name="pre-defined-vm-sizes"></a>Pre-defined VM sizes
...
## <a name="specifying-a-size-during-vm-creation"></a>Specifying a size during VM creation
...
## <a name="resizing-an-existing-vm"></a>Resizing an existing VM
