---
ms.openlocfilehash: 5619f6cde3fab4754b05ac7064b216a12e02d9d7
...
## <a name="what-are-powershell-cmdlets"></a>What are PowerShell cmdlets?
...
## <a name="what-is-the-az-module"></a>What is the Az module?
...
### <a name="install-the-az-module"></a>Install the Az module
...
#### <a name="script-execution-failed"></a>Script execution failed
...
### <a name="update-a-module"></a>Update a module
...
## <a name="example-how-to-create-a-resource-group-with-azure-powershell"></a>Example: How to create a resource group with Azure PowerShell
...
### <a name="import-the-azure-cmdlets"></a>Import the Azure cmdlets
...
### <a name="working-with-subscriptions"></a>Working with subscriptions
...
### <a name="get-a-list-of-all-resource-groups"></a>Get a list of all Resource Groups
...
### <a name="verify-the-resources"></a>Verify the resources
...
### <a name="creating-an-azure-virtual-machine"></a>Creating an Azure Virtual Machine
...
#### <a name="example-getting-the-information-for-a-vm"></a>Example: getting the information for a VM
