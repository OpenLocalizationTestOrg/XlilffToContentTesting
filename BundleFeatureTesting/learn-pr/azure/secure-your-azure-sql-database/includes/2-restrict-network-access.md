---
ms.openlocfilehash: 36ce6c537bb9cad4b8a34509bf258a2ed72ff254
...
## <a name="firewall-rules"></a>Firewall rules
...
### <a name="server-level-firewall-rules"></a>Server-level firewall rules
...
### <a name="database-level-firewall-rules"></a>Database-level firewall rules
...
## <a name="restricting-network-access-in-practice"></a>Restricting network access in practice
...
### <a name="use-the-server-level-allow-access-to-azure-services-rule"></a>Use the server-level allow access to Azure services rule
...
### <a name="use-a-database-level-ip-address-rule"></a>Use a database-level IP address rule
...
#### <a name="use-a-server-level-ip-address-rule"></a>Use a server-level IP address rule
...
#### <a name="use-a-server-level-virtual-network-rule"></a>Use a server-level virtual network rule
