---
ms.openlocfilehash: 1186b3265a97f2ed77bb12ba3d78761c2b2bc887
...
## <a name="create-an-azure-cache-for-redis"></a>Create an Azure Cache for Redis
...
### <a name="select-a-location"></a>Select a location
<!-- Resource selection -->
...
## <a name="create-a-net-core-console-application"></a>Create a .NET Core console application
...
## <a name="add-the-servicestackredis-nuget-package"></a>Add the ServiceStack.Redis NuGet package
...
## <a name="get-your-azure-cache-for-redis-connection-string"></a>Get your Azure Cache for Redis connection string
...
## <a name="add-the-connection-string-to-your-app"></a>Add the connection string to your app
...
## <a name="insert-two-data-values-into-your-azure-cache-for-redis"></a>Insert two data values into your Azure Cache for Redis
