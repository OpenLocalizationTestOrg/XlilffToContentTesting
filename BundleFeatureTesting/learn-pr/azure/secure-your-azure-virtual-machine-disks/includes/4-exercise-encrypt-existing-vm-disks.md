---
ms.openlocfilehash: 9dcb30b6ddaf6b81dc7a3fea095a57d341e895c1
...
## <a name="prepare-the-environment"></a>Prepare the environment

We'll start by deploying a new Windows VM in an Azure Virtual Machine.

### <a name="deploy-windows-vm"></a>Deploy Windows VM
...
## <a name="encrypt-the-vm-disks-with-azure-disk-encryption"></a>Encrypt the VM disks with Azure Disk Encryption
...
### <a name="encrypt-the-disk"></a>Encrypt the disk
