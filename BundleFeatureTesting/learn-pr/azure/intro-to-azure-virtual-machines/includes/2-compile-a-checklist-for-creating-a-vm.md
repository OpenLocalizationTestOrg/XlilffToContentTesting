---
ms.openlocfilehash: de56ce53ca3b2eb33029210394b6efa447976d93
...
#### <a name="required-resources-for-iaas-virtual-machines"></a>Required resources for IaaS Virtual Machines
...
## <a name="start-with-the-network"></a>Start with the network
...
### <a name="segregate-your-network"></a>Segregate your network
...
### <a name="secure-the-network"></a>Secure the network
...
## <a name="plan-each-vm-deployment"></a>Plan each VM deployment
...
### <a name="name-the-vm"></a>Name the VM
...
#### <a name="what-is-an-azure-resource"></a>What is an Azure resource?
...
### <a name="decide-the-location-for-the-vm"></a>Decide the location for the VM
...
### <a name="determine-the-size-of-the-vm"></a>Determine the size of the VM
...
### <a name="what-if-my-size-needs-change"></a>What if my size needs change?
...
### <a name="understanding-the-pricing-model"></a>Understanding the pricing model
...
### <a name="storage-for-the-vm"></a>Storage for the VM
...
### <a name="select-an-operating-system"></a>Select an operating system
