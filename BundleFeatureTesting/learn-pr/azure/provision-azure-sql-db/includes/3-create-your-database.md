---
ms.openlocfilehash: 953d3861d9bc699f8646f4dcf31f35f733ab1d55
...
## <a name="one-server-many-databases"></a>One server, many databases
...
## <a name="choose-performance-dtus-versus-vcores"></a>Choose performance: DTUs versus vCores

Azure SQL Database has two purchasing models: DTU and vCore.

### <a name="what-are-dtus"></a>What are DTUs?
...
### <a name="what-are-vcores"></a>What are vCores?
...
## <a name="what-are-sql-elastic-pools"></a>What are SQL elastic pools?
...
## <a name="what-is-collation"></a>What is collation?
...
## <a name="create-your-azure-sql-database"></a>Create your Azure SQL database
...
## <a name="set-the-server-firewall"></a>Set the server firewall
