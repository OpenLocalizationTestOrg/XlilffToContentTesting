---
ms.openlocfilehash: 9f891e866c6e7c131584bde20a6533df7ee7360f
...
## <a name="what-about-express"></a>What about Express?
...
## <a name="what-about-angularjs"></a>What about AngularJS?
...
## <a name="how-will-i-build-the-application"></a>How will I build the application?
...
## <a name="create-the-books-web-application"></a>Create the Books web application
...
### <a name="create-the-files"></a>Create the files
...
### <a name="create-the-express-routes-that-handle-http-requests"></a>Create the Express routes that handle HTTP requests
...
### <a name="create-the-client-side-javascript-application"></a>Create the client-side JavaScript application
...
### <a name="create-the-express-server-to-host-the-application"></a>Create the Express server to host the application
...
### <a name="define-package-information-and-dependencies"></a>Define package information and dependencies
...
### <a name="copy-the-files-to-your-vm"></a>Copy the files to your VM
...
## <a name="install-additional-node-packages"></a>Install additional Node packages
