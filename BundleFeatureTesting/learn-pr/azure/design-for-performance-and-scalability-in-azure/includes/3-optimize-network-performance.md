---
ms.openlocfilehash: 80e3657f1b87e3d373be9482aa99ca58340a69aa
...
## <a name="the-importance-of-network-latency"></a>The importance of network latency
...
## <a name="latency-between-azure-resources"></a>Latency between Azure resources
...
## <a name="latency-between-users-and-azure-resources"></a>Latency between users and Azure resources
...
### <a name="use-a-dns-load-balancer-for-endpoint-path-optimization"></a>Use a DNS load balancer for endpoint path optimization
...
### <a name="use-cdn-to-cache-content-close-to-users"></a>Use CDN to cache content close to users
...
### <a name="use-expressroute-for-connectivity-from-on-premises-to-azure"></a>Use ExpressRoute for connectivity from on-premises to Azure
