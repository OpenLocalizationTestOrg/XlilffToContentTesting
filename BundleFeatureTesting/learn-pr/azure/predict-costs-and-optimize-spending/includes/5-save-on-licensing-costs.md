---
ms.openlocfilehash: 15808a0e99531e1b6349314e69b28bf65d595e01
...
## <a name="linux-vs-windows"></a>Linux vs. Windows
...
## <a name="azure-hybrid-benefit-for-windows-server"></a>Azure Hybrid Benefit for Windows Server
...
## <a name="azure-hybrid-benefit-for-sql-server"></a>Azure Hybrid Benefit for SQL Server
...
### <a name="azure-sql-database-vcore-based-options"></a>Azure SQL Database vCore-based options
...
## <a name="use-devtest-subscription-offers"></a>Use Dev/Test subscription offers
...
## <a name="bring-your-own-sql-server-license"></a>Bring your own SQL Server license
...
## <a name="use-sql-server-developer-edition"></a>Use SQL Server Developer Edition
...
## <a name="use-constrained-instance-sizes-for-database-workloads"></a>Use constrained instance sizes for database workloads
