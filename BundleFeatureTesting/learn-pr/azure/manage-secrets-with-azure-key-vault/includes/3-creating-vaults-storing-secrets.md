---
ms.openlocfilehash: 98aab4d245f76690f396e9c0cb07e8fa508ef6f9
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/24/2019
---
## <a name="creating-key-vaults-for-your-applications"></a>Creating Key Vaults for your applications
...
## <a name="vault-authentication-and-permissions"></a>Vault authentication and permissions
...
## <a name="create-the-vault-and-store-the-secret-in-it"></a>Create the vault and store the secret in it

To start, you'll create a vault and store one secret.

### <a name="create-the-vault"></a>Create the vault
...
### <a name="add-the-secret"></a>Add the secret
