---
ms.openlocfilehash: ee98ed46fef0d8f9907f5ee479415da1348aab4a
...
## <a name="create-a-blob-trigger"></a>Create a blob trigger
...
## <a name="turn-on-your-blob-trigger"></a>Turn on your blob trigger
...
## <a name="create-a-blob"></a>Create a blob
