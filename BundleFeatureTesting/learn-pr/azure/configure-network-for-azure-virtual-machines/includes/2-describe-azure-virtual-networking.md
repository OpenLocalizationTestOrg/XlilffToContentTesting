---
ms.openlocfilehash: e2b28a1925b642540621a4437cc7a873476cbc52
...
## <a name="what-is-azure-virtual-networking"></a>What is Azure virtual networking?
...
#### <a name="network-configurations-for-virtual-machines"></a>Network configurations for virtual machines

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE2yEve]

### <a name="isolation-and-segmentation"></a>Isolation and segmentation
...
### <a name="internet-communications"></a>Internet communications
...
### <a name="communicate-between-azure-resources"></a>Communicate between Azure resources
...
### <a name="communicate-with-on-premises-resources"></a>Communicate with on-premises resources
...
### <a name="route-network-traffic"></a>Route network traffic
...
### <a name="filter-network-traffic"></a>Filter network traffic
...
## <a name="connect-virtual-networks"></a>Connect virtual networks
...
## <a name="azure-virtual-network-settings"></a>Azure virtual network settings
...
### <a name="define-additional-settings"></a>Define additional settings
...
### <a name="configure-virtual-networks"></a>Configure virtual networks
